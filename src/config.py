...
PROVIDER_CIRCUIT_COOLDOWN_SECONDS = float(os.getenv("PROVIDER_CIRCUIT_COOLDOWN_SECONDS", "5"))
...
JOB_STALE_RECOVERY_SECONDS = int(os.getenv("JOB_STALE_RECOVERY_SECONDS", "1800"))
